...
import org.snmp4j.{Target => snmpTarget}
...
class TreeEventGraph(treeUtils: TreeUtils, target: snmpTarget, rootOids: OID*) extends GraphStageWithMaterializedValue[SourceShape[TreeEvent], Cancellable] {
